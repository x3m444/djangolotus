...
ASGI_APPLICATION = 'lotus.asgi.application'
...
# Sessions pe cookie — elimină round-trip DB la fiecare request
...
AUTH_ENABLED = config('AUTH_ENABLED', default=False, cast=bool)

AUTHENTICATION_BACKENDS = [
    'apps.core.auth_backend.UtilizatoriBackend',
]
